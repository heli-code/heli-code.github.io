...
public class ArtistServiceImpl extends ServiceImpl<ArtistMapper, Artist> implements IArtistService {
    ...
    public Result<String> addArtist(ArtistAddDTO artistAddDTO) {
        QueryWrapper<Artist> queryWrapper = new QueryWrapper<>();
    ...
    @Override
    @CacheEvict(cacheNames = "artistCache", allEntries = true)
    public Result<String> updateArtist(ArtistUpdateDTO artistUpdateDTO) {
    ...
    @Override
    @CacheEvict(cacheNames = "artistCache", allEntries = true)
    public Result<String> updateArtistAvatar(Long artistId, String avatar) {
    ...
    @Override
    @CacheEvict(cacheNames = "artistCache", allEntries = true)
    public Result<String> deleteArtist(Long artistId) {
        // 1. 查询歌手信息，获取头像 URL
        Artist artist = artistMapper.selectById(artistId);
        if (artist == null) {
    ...
    public Result<String> deleteArtists(List<Long> artistIds) {
